...
<img src="%E8%87%AA%E5%AE%9A%E4%B9%89%E9%95%9C%E5%83%8F.assets/image-1722586647646.png" alt="img" style="zoom:33%;" />
...
#制定映射mulu
VOLUME /tmp
#将jar添加到容易并更名为zzyy_docker.jar
ADD docker_boot-0.0.0.1.jar zzyy_docker.jar
#运行jar报,c指cmd touch是修改文件时间
RUN bash -c 'touch /zzyy_docker.jar'
ENTRYPOINT["java","-jar","zzyy_docker.jar"]
#暴露端口作为服务，目前还是镜像，容器才有映射
EXPOSE 6001
```
...
* 构建镜像
  ...
  ```sh
  # .指当前文件夹，zzyy_docker是你自己起的容器名字
  docker build -t zzyy_docker:1.*6 .
  ```

* 运行容器docker run -d -p 6001: 6001 15a1424eae6c